...
const UUID = process.env.UUID || '3862c58d-f425-41af-80e8-d5f9b1c3a047'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'iq1r9uCBejmoq7uA2heq0VsN7aoiVWB3';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'node6.lunes.host';    // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
...
const NAME = process.env.NAME || 'US-lunes';                       // 节点名称
const PORT = process.env.PORT || 3261;                     // http和ws服务端口
