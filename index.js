...
const UUID = process.env.UUID || 'e1da4acd-63ef-4fe1-aed6-30458ee6136b';
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.thall.ggff.net:8008';
const NEZHA_PORT = process.env.NEZHA_PORT || '';
const NEZHA_KEY = process.env.NEZHA_KEY || 'iq1r9uCBejmoq7uA2heq0VsN7aoiVWB3';
const DOMAIN = process.env.DOMAIN || 'node6.lunes.host';
const AUTO_ACCESS = process.env.AUTO_ACCESS || false;
const WSPATH = process.env.WSPATH || UUID.slice(0, 8);
const SUB_PATH = process.env.SUB_PATH || 'sub';
const NAME = process.env.NAME || '';
const PORT = process.env.PORT || 3261;
